...
collectibleImg.src = "images/diamond.png";
...
function render() {
   ...
   drawEntity(collectibleImg, collectible.x, collectible.y, "#facc15", 2);
   
   bombs.forEach(bomb => {
       drawEntity(bomba, bomb.x, bomb.y, "#ef4444", 2.3);
   });
   
   drawEntity(bomberman, player.x, player.y, "#3b82f6", 2.5);
}
